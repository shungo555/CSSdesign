...
REM set train_dir_name=build/%dataset%/Canon20D_srgb_noise0
set train_dir_name=build/%dataset%/CSS_change_srgb_noise0_ep_7_fixed_Canon20D_100
...
cd %CSS_dir%bin
convert mat to npy
python ../lib/convert_data/mat2npy.py --mat ../%RI_mat_file_name% --npy ../%RI_npy_file_name% --name out
...
python ../lib/image_tools/color_correction.py --crgb %test_dir_name%/RI.npy --output %test_dir_name%/crgb2srgbRI.npy --gain %test_dir_name%/gains.npy --dataset %dataset%
...
python ../lib/image_tools/evaluation.py --input1 %true_srgb_file_name% --input2 %test_dir_name%/crgb2srgbRI.npy --output  %test_dir_name%/result_RI_CC.csv
...
python ../lib/image_tools/draw_image.py --input %test_dir_name%/crgb2srgbRI.npy --output %test_dir_name%/img/ --title crgb2srgbRI --gamma